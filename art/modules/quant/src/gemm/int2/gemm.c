...
"int2_dim_m4x16_loop_%=:\n\t"
"cmp %[dim_m], #4\n\t"
"blt int2_finish_dim_m4x16_loop_%=\n\t"
"mov x8, %[dim_n]\n\t"
"mov x9, %[addr_b]\n\t"

"int2_dim_n4x16_loop_%=:\n\t"
"cmp x8, #16\n\t"
"blt int2_finish_dim_n4x16_loop_%=\n\t"
"mov x10, %[addr_a]\n\t"
"mov x11, %[dim_k]\n\t"
...
"int2_dim_k4x16x16_loop_%=:\n\t"
"cmp x11, #224\n\t"
"blt int2_finish_dim_k4x16x16_loop_%=\n\t"
"mov x12, #8\n\t"

"int2_dim_k4x16x16_16232_loop_%=:\n\t"
"cmp x12, #0\n\t"
"beq int2_finish_dim_k4x16x16_16232_loop_%=\n\t"
"mov x13, #3\n\t"
...
"int2_dim_k4x16x16_8216_loop_%=:\n\t"
"cmp x13, #0\n\t"
"beq int2_finish_dim_k4x16x16_8216_loop_%=\n\t"
...
"b int2_dim_k4x16x16_8216_loop_%=\n\t"
"int2_finish_dim_k4x16x16_8216_loop_%=:\n\t"
...
"b int2_dim_k4x16x16_16232_loop_%=\n\t"
"int2_finish_dim_k4x16x16_16232_loop_%=:\n\t"
...
"b int2_dim_k4x16x16_loop_%=\n\t"
"int2_finish_dim_k4x16x16_loop_%=:\n\t"

"int2_dim_k4x16x14_loop_%=:\n\t"
"cmp x11, #8\n\t"
"blt int2_finish_dim_k4x16x14_loop_%=\n\t"
...
"b int2_dim_k4x16x14_loop_%=\n\t"
"int2_finish_dim_k4x16x14_loop_%=:\n\t"

"int2_dim_k4x16x1_loop_%=:\n\t"
"cmp x11, #0\n\t"
"beq int2_finish_dim_k4x16x1_loop_%=\n\t"
...
"b int2_dim_k4x16x1_loop_%=\n\t"
"int2_finish_dim_k4x16x1_loop_%=:\n\t"
...
"b int2_dim_n4x16_loop_%=\n\t"
"int2_finish_dim_n4x16_loop_%=:\n\t"

"sub %[dim_m], %[dim_m], #4\n\t"
"add %[addr_a], %[addr_a], %[a_offset]\n\t"
"add %[addr_c], %[addr_c], %[resume_n_offset]\n\t"
"b int2_dim_m4x16_loop_%=\n\t"
"int2_finish_dim_m4x16_loop_%=:\n\t"
: // output
: // input
