...
"int4_dim_m4x16_loop_%=:\n\t"
"cmp %[dim_m], #4\n\t"
"blt int4_finish_dim_m4x16_loop_%=\n\t"
"mov x4, %[dim_n]\n\t"
"mov x5, %[addr_b]\n\t"

"int4_dim_n4x16_loop_%=:\n\t"
"cmp x4, #16\n\t"
"blt int4_finish_dim_n4x16_loop_%=\n\t"
"mov x6, %[addr_a]\n\t"
"mov x7, %[dim_k]\n\t"
...
"int4_dim_k4x16x32_loop_%=:\n\t"
"cmp x7, #32\n\t"
"blt int4_finish_dim_k4x16x32_loop_%=\n\t"
...
"b int4_dim_k4x16x32_loop_%=\n\t"
"int4_finish_dim_k4x16x32_loop_%=:\n\t"
...
"int4_dim_k4x16x1_loop_%=:\n\t"
"cmp x7, #0\n\t"
"beq int4_finish_dim_k4x16x1_loop_%=\n\t"
...
"b int4_dim_k4x16x1_loop_%=\n\t"
"int4_finish_dim_k4x16x1_loop_%=:\n\t"
...
"b int4_dim_n4x16_loop_%=\n\t"
"int4_finish_dim_n4x16_loop_%=:\n\t"

"sub %[dim_m], %[dim_m], #4\n\t"
"add %[addr_a], %[addr_a], %[a_offset]\n\t"
"add %[addr_c], %[addr_c], %[resume_n_offset]\n\t"
"b int4_dim_m4x16_loop_%=\n\t"
"int4_finish_dim_m4x16_loop_%=:\n\t"
: // output
: // input
