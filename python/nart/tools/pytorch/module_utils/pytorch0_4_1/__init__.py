...
def size(self, *args, **kwargs):
    return torch.Tensor.ori_size(self.data, *args, **kwargs)
...
class convert_mode:
    def __init__(self):
        self.package = "nart.tools.pytorch.module_utils.pytorch0_4_1"
    ...
    def replace_lstmcell(self):
        torch.nn.backends.thnn.backend.ori_LSTMCell = (
    ...
    def restore_lstmcell(self):
        ...
        delattr(torch.nn.backends.thnn.backend, "ori_LSTMCell")
