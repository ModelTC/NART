...
class ROIPool(Layer):
    ...
    def set_param(self):
        ...
        self.params.roi_pooling_param.spatial_scale = attributes["spatial_scale"].f
        self.params.roi_pooling_param.pooled_h = attributes["pooled_height"].i
        self.params.roi_pooling_param.pooled_w = attributes["pooled_width"].i
    ...
    def set_blobshape(self):
        self.network.blobshape[self.params.top[0]] = [
            ...
            self.params.roi_pooling_param.pooled_h,
            self.params.roi_pooling_param.pooled_w,
        ]
